 ...
 * StatsdClient.java
 *
 * Example StatsD client code can be found here https://github.com/etsy/statsd/blob/master/examples/StatsdClient.java
 * This example has been extended to add the ability to increment a gauge (all increment methods in the original example
...
public class StatsdClient extends TimerTask {
    ...
    public boolean incrementGauge(String key, double magnitude) {
        final String stat = String.format(Locale.ENGLISH, "%s:+%s|g", key,magnitude);
